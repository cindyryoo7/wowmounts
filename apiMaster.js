...
const getUserMounts = async (accessToken) => {
  try {
    let response = await axios.get(`https://us.api.blizzard.com/profile/user/wow/collections/mounts?namespace=profile-us&locale=en_US&access_token=${accessToken}`)
  } catch (err) {
